...
urlpatterns = [
    ...
    path('eliminar-orden-salida/', views.deleteOrderOutput, name="deleteOrderOutput"),
    path('detalles-orden-salida/<int:orderid>/', views.outputDetails, name="outputDetails"),
